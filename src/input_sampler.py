...
if __name__ == "__main__":
    vowel_file = '../training_data/hillenbrand_vowel_acoustics.csv'
    word_file = '../training_data/childes_counts_prons.csv'
    words, vowel_samples, vowel_labels = sample_inputs(vowel_file, word_file, ['f1', 'f2'])
